...
const DEEP_REPORT_PROMPT = [
  ...
  "",
  "Gather first (call each once): portfolio.summary; portfolio.positions; portfolio.performance (days 180); portfolio.byStrategy for each strategy tag in the notes — at least 'Algo' and 'Leopold'; portfolio.savings; market.quote for the benchmarks ^GSPC and ^IXIC.",
  "",
  ...
  "## Portfolio overview — value, cost basis, unrealized/realized P&L, dividends. Include a viz.chart DONUT of allocation by the top positions (real symbols + an 'Other' bucket).",
