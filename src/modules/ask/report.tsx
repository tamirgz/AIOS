...
export async function renderAskReportPdf(entry: {
  ...
  const doc = (
    <Document
      title={`AIOS report — ${entry.query.slice(0, 60)}`}
      author="AIOS"
      creator="AIOS Ask"
    >
      <Page size="A4" style={styles.page}>
        <View style={styles.headerRow} fixed>
          <Text style={styles.eyebrow}>AIOS · Knowledge Report</Text>
          <View>
        ...
        <View style={styles.footer} fixed>
          <Text>Generated by AIOS — answered only from your own saved data.</Text>
          <Text
