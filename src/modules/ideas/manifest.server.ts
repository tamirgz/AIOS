  ...
  agentTemplates: [
    {
      ...
      defaultPrompt:
        "Review my idea pipeline with ideas.list (stages spark and exploring). Considering my memory context (who I am, current focus), pick the 1-2 ideas most worth advancing this week and say why in one sentence each; flag any that should be parked. Send the conclusion with notify.send (title 'Idea review'). Use ledger.mark with the ISO week so a same-week re-run is a no-op after checking ledger.has.",
