...
**Awaiting you (3 five-minute setups).** ① GCP OAuth client → Settings (calendar colors now, Gmail later — same client). ② Slack bot token + channel IDs `C0B7TLBJ4LU, C0B7VNRPQSV`. ③ Slack incoming webhook.
